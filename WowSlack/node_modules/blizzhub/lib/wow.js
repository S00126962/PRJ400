        ...
        constructor(bearerToken) {
            ...
            this.getCharacterProfile = (region, realm, characterName, locale, fields) => {
                if (typeof fields == 'undefined' || fields == "")
                    return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/character/${realm}/${characterName}
                    ?locale=${locale}&access_token=${this.token.identifier}`);
                else
                    return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/character/${realm}/${characterName}
                    ?fields=${escape(fields)}&locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            this.getAchivements = (region, realm, characterName, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/character/${realm}/${characterName}
                ?fields=achivements&locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            this.getAppearance = (region, realm, characterName, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/character/${realm}/${characterName}
                ?fields=appearance&locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            this.getFeed = (region, realm, characterName, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/character/${realm}/${characterName}
                ?fields=feed&locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            this.getGuild = (region, realm, characterName, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/character/${realm}/${characterName}
                ?fields=guild&locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            this.getHunterPets = (region, realm, characterName, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/character/${realm}/${characterName}
                ?fields=hunterPets&locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            this.getItems = (region, realm, characterName, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/character/${realm}/${characterName}
                ?fields=items&locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            this.getMounts = (region, realm, characterName, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/character/${realm}/${characterName}
                ?fields=mounts&locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            this.getPets = (region, realm, characterName, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/character/${realm}/${characterName}
                ?fields=pets&locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            this.getPetSlots = (region, realm, characterName, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/character/${realm}/${characterName}
                ?fields=petSlots&locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            this.getProfessions = (region, realm, characterName, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/character/${realm}/${characterName}
                ?fields=professions&locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            this.getProgression = (region, realm, characterName, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/character/${realm}/${characterName}
                ?fields=progression&locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            this.getPVP = (region, realm, characterName, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/character/${realm}/${characterName}
                ?fields=pvp&locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            this.getQuests = (region, realm, characterName, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/character/${realm}/${characterName}
                ?fields=quests&locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            this.getReputations = (region, realm, characterName, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/character/${realm}/${characterName}
                ?fields=reputation&locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            this.getStatistics = (region, realm, characterName, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/character/${realm}/${characterName}
                ?fields=statistics&locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            this.getStats = (region, realm, characterName, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/character/${realm}/${characterName}
                ?fields=stats&locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            this.getTalents = (region, realm, characterName, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/character/${realm}/${characterName}
                ?fields=talents&locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            this.getTitles = (region, realm, characterName, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/character/${realm}/${characterName}
                ?fields=titles&locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            this.getAudit = (region, realm, characterName, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/character/${realm}/${characterName}
                ?fields=audit&locale=${locale}&access_token=${this.token.identifier}`);
            };
            this.token = bearerToken;
        }
        /**
        ...
        constructor(bearerToken) {
            ...
            */
            this.getProfile = (region, realm, guildName, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/guild/${realm}/${guildName}?
                fields=achievements%2Cchallenge&locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            */
            this.getMembers = (region, realm, guildName, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/guild/${realm}/${guildName}?
                fields=members&locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            */
            this.getAchivements = (region, realm, guildName, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/guild/${realm}/${guildName}?
                fields=achievements&locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            */
            this.getNews = (region, realm, guildName, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/guild/${realm}/${guildName}?
                fields=news&locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            */
            this.getChallenge = (region, realm, guildName, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/guild/${realm}/${guildName}?
                fields=challenge&locale=${locale}&access_token=${this.token.identifier}`);
            };
            this.token = bearerToken;
        }
        /**
        ...
        */
        constructor(bearerToken) {
            ...
            this.getItem = (region, itemId, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/item/${itemId}?
                locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
             * The item API provides detailed item information, including item set information.
            ...
            this.getItemSet = (region, setId, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/set/${setId}?
                locale=${locale}&access_token=${this.token.identifier}`);
            };
            this.token = bearerToken;
        }
        ...
        */
        constructor(bearerToken) {
            ...
            this.getStats = (region, speciesID, level, breedId, qualityId, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/pet/stats/${speciesID}?level=${level}&breedId=${breedId}&qualityId=${qualityId}&
                locale=${locale}&access_token=${this.token.identifier}`);
            };
            this.token = bearerToken;
        }
        ...
        */
        constructor(bearerToken) {
            ...
            this.getRecipe = (region, recipeId, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/recipe/${recipeId}?
                locale=${locale}&access_token=${this.token.identifier}`);
            };
            this.token = bearerToken;
        }
        ...
        */
        constructor(bearerToken) {
            ...
            this.getSpell = (region, spellId, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/spell/${spellId}?
                locale=${locale}&access_token=${this.token.identifier}`);
            };
            this.token = bearerToken;
        }
        ...
        */
        constructor(bearerToken) {
            ...
            this.getBattlegrounds = (region, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/data/battlegroups/?
                locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            this.getCharacterRaces = (region, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/data/character/races?
                locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            this.getCharacterClasses = (region, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/data/character/classes?
                locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            this.getCharacterAchivements = (region, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/data/character/achievements?
                locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            this.getGuildRewards = (region, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/data/guild/rewards?
                locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            this.getGuildPerks = (region, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/data/guild/perks?
                locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            this.getGuildAchivements = (region, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/data/guild/achievements?
                locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            this.getItemClasses = (region, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/data/item/classes?
                locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            this.getTalents = (region, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/data/talents?
                locale=${locale}&access_token=${this.token.identifier}`);
            };
            /**
            ...
            this.getPetTypes = (region, locale) => {
                return httpRequest_1.HttpRequest.get(`https://${region}.api.blizzard.com/wow/data/pet/types?
                locale=${locale}&access_token=${this.token.identifier}`);
            };
            this.token = bearerToken;
        }
